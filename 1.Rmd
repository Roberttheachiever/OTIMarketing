...
*Note: 20000+ students have taken 1 class, very few have taken 4 and 5.
...
### Preparing Data:   
```{r Clean data remove Student that have only taking 1 course, echo=FALSE}
...
### Conclusion
The finding do show using the POPULAR model returns a lower RMSE of 10.740 than UBCF 10.4894 and IBCF 11.59713 with the dataset I used. The dataset that I used for this project was 10th the size of the actual data I have access to but was not authoried to use for this project as originally planned. Therefore the lack of records and knowing that RecommendLab works best with large sets of data my result were also lacking in apeal.
